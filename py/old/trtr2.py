...
if __name__=='__main__':
  ...
  p = Pool(8)
  cmd = "cd /home/yiyusheng/Code/C/OnlineRF/online_rfr;./OMCBoost -c conf/train_train.conf --orfr --train --test -negPoisson 0.05 -trainIndEnd %s -testIndEnd 587005 -testP 1 > /home/yiyusheng/Data/log/OnlineRF/%s"

  len_id = len(train2_lastid)
  #len_id = 3
  for i in range(len_id):
    p.apply_async(exec_cmd,args=(cmd,train2_lastid[i]))
  p.close()
  p.join()
