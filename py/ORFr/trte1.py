...
if __name__=='__main__':
  ...
  cmd = "cd /home/yiyusheng/Code/C/OnlineRF/online_rfr;./OMCBoost -c conf/smart1_train_test.conf --orfr --train --test -negPoisson %s -trainIndEnd %s -testP 1 -outP %s > /home/yiyusheng/Data/log/OnlineRF/ORFr/%s_%s_%s"
