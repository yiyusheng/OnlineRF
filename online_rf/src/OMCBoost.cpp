...
int main(int argc, char *argv[]) {
    ...
    dataset_tr.load(hp.trainData, hp.trainLabels, hp.trainSnids, hp.trainIndStart, hp.trainIndEnd);
...
//    dataset_tr.m_numSamples = dataset_tr.m_samples.size();
    if (doT2 || doTesting) {
        dataset_ts.load(hp.testData, hp.testLabels, hp.testSnids, hp.testIndStart, hp.testIndEnd);
    }
